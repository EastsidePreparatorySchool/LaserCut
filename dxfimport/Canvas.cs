...
namespace LaserCut
{
	...
	public class Canvas : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.pictureBox1.Size = new System.Drawing.Size(488, 294);
            ...
            this.MinimumSize = new System.Drawing.Size(540, 254);
            this.Name = "Canvas";
            ...
            this.DoubleClick += new System.EventHandler(this.MouseDoubleClick2);
		...
		private void LineModule (StreamReader reader)		//Interpretes line objects in the DXF file
		{
			...
			int ix = drawingList.Add(new Line (new PointF((float)x1, (float)-y1), new PointF((float)x2, (float)-y2) , Color.Red));
		...
		private void CircleModule (StreamReader reader)		//Interpretes circle objects in the DXF file
		{
			...
			int ix = drawingList.Add(new circle (new PointF ((float)x1, (float)-y1), radius, Color.Red, Color.Red));
		...
		private void ArcModule (StreamReader reader)		//Interpretes arc objects in the DXF file
		{
			...
			int ix = drawingList.Add(new arc (new PointF ((float)x1, (float)-y1), radius, angle1, angle2, Color.Red, Color.Red));
        ...
        private void MouseDoubleClick2(Object sender, System.EventArgs e)
        {
            Print();
        }
